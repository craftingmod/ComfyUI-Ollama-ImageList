...
- The Image Editor now places Caption directly below the media viewport, uses a wider 1280px-responsive layout for landscape sources, excludes View-only Pan/Zoom changes from Undo history, and restores Interaction mode through Undo/Redo.
